    ...
    return (
        <div>
            <div className='max-w-[1320px] mx-auto'>
                ...
                <div className='grid lg:grid-cols-[20%_auto] grid-cols-1 mt-[30px]'>
                    <div className='order-2 lg:order-1'>
                        ...
                        <div className='p-[15px] h-[350px] overflow-y-scroll scroll'>
                            ...
                            <ul className='leading-[35px] text-[rgb(90,90,90)] mt-[10px]'>
                                ...
                                <li><input type="checkbox" /> Marandi Wood</li>
                                <li><input type="checkbox" /> Mahogany Wood</li>
                                <li><input type="checkbox" /> Deodar Wood</li>
                        ...
                        <div className='p-[15px]'>
                            ...
                            <ul className='leading-[35px] text-[rgb(90,90,90)] mt-[10px]'>
                                ...
                                <li><input type="checkbox" /> Mango Green</li>
                        ...
                        <div className='lg:flex shadow p-[15px] md:block md:text-center gap-[20px] text-[15px] text-[rgb(90,90,90)] lg:justify-end lg:items-center'>
                            ...
                            <div className='mx-auto text-center mt-[10px]'>
                                <select
                                    name="sort"
                                    id="sort"
                                    className="border py-[3px] px-[10px] rounded min-w-max "
                                >
